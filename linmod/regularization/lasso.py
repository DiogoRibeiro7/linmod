# linmod/regularization/lasso.py
"""
...
class LassoLinearModel(BaseLinearModel):
    def __init__(self, lambda_: float = 1.0, max_iter: int = 1000, tol: float = 1e-4):
        super().__init__()
